function man --wraps man
    ...
    set -q man_bold; and set -l bold (set_color $man_bold); or set -l bold (set_color -o blue)
    set -q man_standout; and set -l standout (set_color $man_standout); or set -l standout (set_color green)
    set -q man_underline; and set -l underline (set_color $man_underline); or set -l underline (set_color -u magenta)
